...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 0 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 16 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 32 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 48 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 64 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 80 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 96 ~ run function netherspawn:locate_chest_y_subchunk
...
execute unless score chunk_y locate_chest_y matches 0..127 at @s positioned ~ 112 ~ run function netherspawn:locate_chest_y_subchunk
