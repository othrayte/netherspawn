...
function netherspawn:spawn/enumerate_spawning_locations
...
execute unless entity @e[tag=valid_spawn_location] run tellraw @a [{"text": "[NetherSpawn] "},{"text": "ERROR", "color":"red"},{"text": ": No valid spawning locations found at ruined portal"}]
