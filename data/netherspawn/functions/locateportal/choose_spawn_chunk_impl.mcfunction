...
execute if score debug netherspawn matches 1 unless score d hone_chunk matches 0 run tellraw @a [{"text": "[NetherSpawn] "},{"text": "ERROR", "color":"red"},{"text": ": Failed to locate ruined portal near 0,0 to spawn at"}]
