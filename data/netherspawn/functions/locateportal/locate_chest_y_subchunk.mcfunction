...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~ ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~1 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~2 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~3 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~4 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~5 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~6 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~7 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~8 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~9 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~10 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~11 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~12 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~13 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~14 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
...
execute unless score subchunk_y locate_chest_y matches 0..15 positioned ~ ~15 ~ run function netherspawn:locateportal/locate_chest_y_layer_z
