...
execute as @s at @s if entity @s[nbt={SpawnForced:1b}] run function netherspawn:post_respawn_effects
execute as @s at @s if entity @s[nbt={SpawnForced:1b}] run function netherspawn:decay_portal
